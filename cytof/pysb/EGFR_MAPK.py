...
Expression('degradation_EGFR__Y1173_p_rate', EGFR_degradation_rate*degradation_EGFR__Y1173_p_kr)
...
Expression('free_EGFR__Y1173_p_obs', EGFR__Y1173_p_obs/(1 + iEGFR_0/(INPUT_iEGFR_EGFR__Y1173_p_obs_kd*iEGFR_EGFR__Y1173_p_obs_kd)))
...
Expression('MEK_phosphorylation_S222_activation_rate', MEK_dephosphorylation_S222_base_rate*free_EGFR__Y1173_p_obs*INPUT_MEK_phosphorylation_S222_kr*MEK_phosphorylation_S222_kr/(ERK__Y204_p_obs*INPUT_MEK_deactivation_S222_ERK__Y204_p_kw*MEK_deactivation_S222_ERK__Y204_p_kw + 1.0))
