...
Expression('MEK_phosphorylation_S222_activation_rate', MEK_dephosphorylation_S222_base_rate*free_EGFR__Y1173_p_obs*MEK_phosphorylation_S222_kr/(ERK__Y204_p_obs*MEK_deactivation_S222_ERK__Y204_p_kw + 1.0))
Expression('ERK_phosphorylation_Y204_activation_rate', 1.0*ERK_dephosphorylation_Y204_base_rate*free_MEK__S222_p_obs*ERK_phosphorylation_Y204_kr)
