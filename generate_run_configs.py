...
def generate_linear_scan(STARTS: list[str]):
    ...
    linear_scan_configs = [
        ...
        for (
            (context, features), features_transform, split, pretrain, median_init, freeze_medians,
            ...
            CONTEXTS_FEATURES, FEATURES_TRANSFORM, SPLITS, PRETRAIN, MEDIAN_INIT, FREEZE_MEDIANS,
