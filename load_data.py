...
up_ids = load_ids_from_uniprot(measurement_table_proteomics["UPID"].unique())
...
measurement_table_proteomics.loc[:, "GENENAME"] = measurement_table_proteomics[
    "UPID"
].apply(lambda x: up_ids.get(x))
