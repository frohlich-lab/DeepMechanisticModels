...
Expression('MEK_phosphorylation_S222_base_rate', MEK_dephosphorylation_S222_base_rate*MEK_phosphorylation_S222_base_kr)
...
Expression('MEK_phosphorylation_S222_activation_rate', MEK_dephosphorylation_S222_base_rate*MEK_phosphorylation_S222_kr*(EGFR__Y1173_p_obs*MEK_phosphorylation_S222_EGFR__Y1173_p_kw/(inh_EGFR*iEGFR_0 + 1) + ERBB2__Y1248_p_obs*MEK_phosphorylation_S222_ERBB2__Y1248_p_kw)/(ERK__Y204_p_obs*MEK_deactivation_S222_ERK__Y204_p_kw + 1.0))
Expression('ERK_phosphorylation_Y204_activation_rate', 1.0*ERK_dephosphorylation_Y204_base_rate*MEK__S222_p_obs*ERK_phosphorylation_Y204_kr/(inh_MEK*iMEK_0 + 1))
Expression('RPS6KA1_phosphorylation_S380_activation_rate', 1.0*RPS6KA1_dephosphorylation_S380_base_rate*ERK__Y204_p_obs*RPS6KA1_phosphorylation_S380_kr)
