...
Parameter('iMEK_pMEK_S222_kd', 0.0)
Parameter('INPUT_iMEK_pMEK_S222_kd', 0.0)
Parameter('iEGFR_0', 0.0)
Parameter('iEGFR_EGF_kd', 0.0)
Parameter('INPUT_iEGFR_EGF_kd', 0.0)
...
Observable('target_EGF', EGF())

Expression('free_EGF', target_EGF/(1 + iEGFR_0/(INPUT_iEGFR_EGF_kd*iEGFR_EGF_kd)))
Expression('free_pMEK_S222', pMEK_S222/(1 + iMEK_0/(INPUT_iMEK_pMEK_S222_kd*iMEK_pMEK_S222_kd)))
Expression('EGFR_phosphorylation_Y1173_activation_rate', 1.0*EGFR_dephosphorylation_Y1173_base_rate*free_EGF*EGFR_phosphorylation_Y1173_kr)
Expression('MEK_phosphorylation_S222_activation_rate', MEK_dephosphorylation_S222_base_rate*EGFR__Y1173_p_obs*MEK_phosphorylation_S222_kr/(ERK__Y204_p_obs*MEK_deactivation_S222_ERK__Y204_p_kw + 1.0))
Expression('ERK_phosphorylation_Y204_activation_rate', 1.0*ERK_dephosphorylation_Y204_base_rate*MEK__S222_p_obs*ERK_phosphorylation_Y204_kr)
