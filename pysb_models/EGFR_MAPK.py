...
Expression('inh_EGF', target_EGF/(INPUT_iEGFR_EGF_kd*iEGFR_EGF_kd))
Expression('inh_MEK', target_MEK/(INPUT_iMEK_MEK_kd*iMEK_MEK_kd))
Expression('EGFR_phosphorylation_Y1173_activation_rate', 1.0*EGFR_dephosphorylation_Y1173_base_rate*EGF_obs*EGFR_phosphorylation_Y1173_kr/(inh_EGF*iEGFR_0 + 1))
