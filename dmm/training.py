...
from .training_helper_funcs import (apply_filter_to_updates, generate_log_epochs, get_eval_model, get_finite_grads,
                                    get_optimiser_and_opt_state, map_params_to_array, model_output_to_petab_input, rmse)
...
def train(
    ...
    opt, opt_state = get_optimiser_and_opt_state(conf=conf, n_epoch=n_epoch, model=model, filter_spec=None)
    ...
    return best_model, rmse_test_min
